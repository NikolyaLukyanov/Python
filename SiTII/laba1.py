...
my_otdels = """Отдел-1:182,230,204,219,161,218,196,161,228,202,164,189,178,240,205,200,153,191,183,231;Отдел-2:236,
...
for my_otdel in my_otdels:
    ...
    print("В отделе", name_otdel, "высокое потребление в дни: ", str(data).strip('[]'), ". Среднее потребление: ",
          mean(electricity_consumptions))
