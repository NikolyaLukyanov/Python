...
def my_analiz(my_department, electric_consums):
    ...
    Args:
        my_department (list): Строка в виде списка, состоящий из названия отдела и показаний
...
Отдел-2:236,213,222,185,163,207,187,163,167,172,193,168,231,218,248,184,174,237,246,188;Отдел-3:248,194,175,170,215,171,157,248,
